...
public final class MyPatternLayout extends AbstractStringLayout {
    ...
    /**
     * Constructs a MyPatternLayout using the supplied conversion pattern.
     *
     ...
     */
    private MyPatternLayout(final Configuration config, final RegexReplacement replace, final DesensitizedReplacement desensitized, final String eventPattern,
    ...
    /**
     * Gets this MyPatternLayout's content format. Specified by:
     * <ul>
     ...
     * </ul>
     *
     * @return Map of content format keys supporting MyPatternLayout
     */
    @Override
    ...
    public static MyPatternLayout createLayout(
            ...
            @PluginElement("desensitized") final DesensitizedReplacement desensitized,
    ...
    private static class PatternSerializer implements Serializer, Serializer2 {
        ...
        private final DesensitizedReplacement desensitized;

        private PatternSerializer(final PatternFormatter[] formatters, final RegexReplacement replace, final DesensitizedReplacement desensitized) {
            super();
        ...
        public StringBuilder toSerializable(final LogEvent event, final StringBuilder buffer) {
            ...
            if (desensitized != null) { // creates temporary objects
                String str = buffer.toString();
                str = desensitized.format(str);
                buffer.setLength(0);
                buffer.append(str);
            }
            return buffer;
    ...
    public static class SerializerBuilder implements org.apache.logging.log4j.core.util.Builder<Serializer> {
        ...
        private DesensitizedReplacement desensitized;
        ...
        public Serializer build() {
            ...
            if (patternSelector == null) {
                try {
                    ...
                    return new PatternSerializer(formatters, replace, desensitized);
                } catch (final RuntimeException ex) {
                    throw new IllegalArgumentException("Cannot parse pattern '" + pattern + "'", ex);
                }
            }
            return new PatternSelectorSerializer(patternSelector, replace, desensitized);
        }
        ...
        public SerializerBuilder setDesensitized(final DesensitizedReplacement desensitized) {
            this.desensitized = desensitized;
            return this;
        }
    ...
    private static class PatternSelectorSerializer implements Serializer, Serializer2 {
        ...
        private PatternSelectorSerializer(final PatternSelector patternSelector, final RegexReplacement replace, final DesensitizedReplacement desensitized) {
            super();
            this.patternSelector = patternSelector;
            this.replace = replace;
            this.desensitized = desensitized;
    ...
    /**
     * Creates a MyPatternLayout using the default options. These options include using UTF-8, the default conversion
    ...
    /**
     * Creates a MyPatternLayout using the default options and the given configuration. These options include using UTF-8,
    ...
    /**
     * Creates a builder for a custom MyPatternLayout.
     *
     * @return a MyPatternLayout builder.
     */
    ...
    /**
     * Custom MyPatternLayout builder. Use the {@link MyPatternLayout#newBuilder() builder factory method} to create this.
     */
    public static class Builder implements org.apache.logging.log4j.core.util.Builder<MyPatternLayout> {

        @PluginBuilderAttribute
        private String pattern = MyPatternLayout.DEFAULT_CONVERSION_PATTERN;
        ...
        public Builder withDesensitizedReplacement(final DesensitizedReplacement desensitized) {
            this.desensitized = desensitized;
            return this;
        }
        ...
        public MyPatternLayout build() {
            ...
            return new MyPatternLayout(configuration, regexReplacement, desensitized, pattern, patternSelector, charset,
